...
export const BRIEF_PROYECTO = {
  ...
  fuera_de_alcance: {
    ...
    placeholder: "Qué NO entra. Es lo que evita las discusiones del mes tres",
  },
  stakeholders: {
    label: "Stakeholders",
    placeholder:
...
export const ESTADOS_TABLERO = ESTADOS_TAREA_ORDEN.filter(
  (e) => e !== "backlog",
);
...
export const BRIEF_TAREA = {
  contexto: {
    label: "Contexto",
    placeholder:
      "Por qué existe: qué problema o pedido la origina y qué se sabe ya",
  },
  resultado: {
    label: "Resultado esperado",
    placeholder:
      "Qué tiene que ser verdad al terminar: criterios de aceptación verificables",
  },
  recursos: {
    label: "Recursos",
  ...
  plan: {
    label: "Plan sugerido",
    placeholder:
      "Pasos en orden para resolverla; quien la agarre puede ajustarlos",
  },
};
...
export const TIPOS_CEREMONIA_ORDEN = Object.keys(
  TIPOS_CEREMONIA,
) as TipoCeremonia[];
...
export const ONE_PAGER_IDEA = {
  problema: {
    label: "Problema",
    placeholder: "Qué problema real resuelve y a quién le duele",
  },
  competencia: {
    label: "Competencia",
    placeholder:
      "Quién lo resuelve hoy, a qué precio, y cuál sería nuestro diferencial",
  },
  solucion: {
    label: "Solución propuesta",
    placeholder: "Cómo se resuelve, versión mínima primero",
  },
  esfuerzo: {
    label: "Esfuerzo estimado",
    placeholder: "Qué implica construirla (tiempo, plata, dependencias)",
  },
  impacto: {
    label: "Impacto esperado",
    placeholder: "Qué cambia si funciona, cómo se mide",
  },
  proximos_pasos: {
    label: "Próximos pasos",
    placeholder: "Qué habría que hacer primero para validarla",
  },
};
